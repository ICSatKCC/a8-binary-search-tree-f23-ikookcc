...
/**Constants for Weke_a. */   


   /** Constant name for this Ia. 
  * Private because not inherited.
  */
   private static final String NAME = "Weke'a";
  ...
  * Private because not inherited.
  */
   private static final String BODY_COLOR = "white with yellow stripe and black spot";
   /** Constant fin color for this Ia. 
  * Private because not inherited.
  */
   private static final String FIN_COLOR = "white";
  ...
  */
   public Weke_a() {
      super(NAME, ENGLISH_NAME, SCIENTIFIC_NAME, WEKE_A_MAX_LENGTH, WEKE_A_MIN_LENGTH, 
          WEKE_A_MIN_LENGTH, (WEKE_A_MIN_LENGTH * 2), DIET_ITEMS,
  ...
  */
   public Weke_a(double length) {
      super(NAME, ENGLISH_NAME, SCIENTIFIC_NAME, WEKE_A_MAX_LENGTH, WEKE_A_MIN_LENGTH, 
          length, (length * 2), DIET_ITEMS, "white with yellow stripe and black spot", 
          "white", "male or female"); 
      this.initSex(); 
   }
}
  
  //There is no level up such as in Oama since nothing levels up to Weke_a!//
